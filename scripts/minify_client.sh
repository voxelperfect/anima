...
cat ../www/js/anima.js ../www/js/renderer.js ../www/js/node.js ../www/js/layer.js ../www/js/scene.js ../www/js/animator.js ../www/js/canvas.js ../www/js/main.js >> anima.js
uglifyjs --mangle-toplevel --unsafe --output ../deploy/anima.min.js anima.js
rm anima.js

# cp ../www/js/main.js ../deploy/
...
sed -i '' 's/<script type="text\/javascript" src="js\/canvas.js"><\/script>/<script type="text\/javascript" src="anima.min.js"><\/script>/g' ../deploy/index.html

sed -i '' 's/<script type="text\/javascript" src="js\/main.js"><\/script>//g' ../deploy/index.html
# sed -i '' 's/<script type="text\/javascript" src="js\/main.js"><\/script>/<script type="text\/javascript" src="main.js"><\/script>/g' ../deploy/index.html
